...
KBUILD_CFLAGS   := -Wno-trigraphs \
		   -Wno-unreachable -Wno-switch-unreachable -Wno-designated-init \
                   -Wno-pointer-to-int-cast -Wno-unused-result -Wno-unused-variable  -fno-strict-aliasing -fno-common -fshort-wchar \
		   -Wno-format-security \
		   -std=gnu89
...
LANG_FLAGS	+= $(call cc-option, -Wno-misleading-indentation)
